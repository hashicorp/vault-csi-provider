...
# ubi build image
# -----------------------------------
FROM registry.access.redhat.com/ubi10/ubi-minimal:10.1-1762189639 AS build-ubi
RUN microdnf --refresh --assumeyes upgrade ca-certificates

# ubi release image
# -----------------------------------
FROM registry.access.redhat.com/ubi10/ubi-micro:10.1-1762215812 AS release-ubi
